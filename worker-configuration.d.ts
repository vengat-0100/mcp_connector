/* eslint-disable */
// Updated for mcp-connector — run `wrangler types` to regenerate
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	MCP_OBJECT: DurableObjectNamespace<import("./src/agent").McpConnectorAgent>;
	SETTINGS_PASSWORD?: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "McpConnectorAgent";
	}
